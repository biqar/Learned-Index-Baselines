...
class ParameterPool(Enum):
    ...
    # RANDOM = Parameter(stages=[1, 10, 100], cores=[[1, 1], [1, 1], [1, 1]], train_steps=[20000, 20000, 20000],
    #                    batch_sizes=[50, 50, 50], learning_rates=[0.0001, 0.0001, 0.0001], keep_ratios=[1.0, 1.0, 1.0])
